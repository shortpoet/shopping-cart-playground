...
export class initDb1607794534017 implements MigrationInterface {
    name = 'initDb1607794534017'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "REL_7b7381059976269b765965c00d" ON "logistics"."purchases" ("product_id") WHERE "product_id" IS NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "logistics"."purchases" ADD CONSTRAINT "FK_7b7381059976269b765965c00d4" FOREIGN KEY ("product_id") REFERENCES "logistics"."products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "logistics"."purchases" DROP CONSTRAINT "FK_7b7381059976269b765965c00d4"`);
        await queryRunner.query(`DROP TABLE "logistics"."customers"`);
        await queryRunner.query(`DROP TABLE "logistics"."transactions"`);
        await queryRunner.query(`DROP INDEX "REL_7b7381059976269b765965c00d" ON "logistics"."purchases"`);
